...
const INTEL_NODES: LearningNode[] = [
  ...
  { name: 'Malware Analytics', tagline: 'Safe triage · behavior · intelligence', route: '/threat-intel/malware-analytics', color: '#fb7185', radius: 12.7, speed: 0.066, tilt: 0.7, size: 0.5, angle: 5.7, rings: true },
